...
from datasets import MIMIC, IUCXR, TextDataset
...
DATASET_NAME = 'MIMIC' # MIMIC / IUCXR
MODEL_NAME = 'Transformer' # Transformer / LSTM
BATCH_SIZE = 32


TEXT_FILE = 'outputs/x_MIMIC_ClsGen_DeiT-384_MaxView2_NumLabel114_History_Hyp.txt'.format(DATASET_NAME)
LABEL_FILE = 'outputs/x_MIMIC_ClsGen_DeiT-384_MaxView2_NumLabel114_History_Lbl.txt'.format(DATASET_NAME)
...
if __name__ == "__main__":
    ...
    if DATASET_NAME == 'MIMIC':
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='/home/chayan/2.CGI/Vocabulary/mimic_unigram_5000.model', max_len=1000)
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='/home/chayan/2.CGI/Vocabulary/iucxr_unigram_1000.model', max_len=1000)
