...
from datasets import IUCXR, MIMIC
from models_deit import Classifier, TNN
from baseline.transformers.models import LSTM_Attn

# --- Instructions ---
# Step 1: Use train_text.py, train LSTM/Transformer models on the MIMIC-CXR dataset (14 diseases + 100 noun-phrases = 114 labels)
# Step 2: Use extract_label.py, load the IUCXR dataset and predict labels using the trained LSTM/Transformer models (CheXpert)
# Step 3: Save the predicted labels and load the IUCXR dataset again with the saved labels
# Step 4: Copy file2label.json to the IUCXR dataset folder
# Step 5: Use train_text.py, train LSTM/Transformer models on the IUCXR dataset
...
if __name__ == "__main__":
    ...
    dataset = IUCXR('/home/chayan/IU-XRay/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='Vocabulary/mimic_unigram_1000.model') 
