...
if DATASET_NAME == 'MIMIC':
    EPOCHS = 35 # Start overfitting after 20 epochs
...
if __name__ == "__main__":
    ...
    checkpoint_path_from = 'checkpoints_old/{}_{}_{}_{}.pt'.format(DATASET_NAME,MODEL_NAME,BACKBONE_NAME,COMMENT)
    checkpoint_path_to = 'checkpoints_old/{}_{}_{}_{}.pt'.format(DATASET_NAME,MODEL_NAME,BACKBONE_NAME,COMMENT)
